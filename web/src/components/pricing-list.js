    ...
    <div className={styles.priceContainer}>
      <Container>
        ...
        <div className={styles.pricingTable}>
          <div className={cn(styles.plan, styles.plan1)}>
            <div className={cn(styles.title, styles.title1)}>
              ...
              <span className={styles.price}>
                <span className={styles.numbers}>$0</span>/month
              </span>
              <div>
                <span className={styles.priceSubtext}>Free Forever</span>
              </div>
            </div>
            <ul className={styles.planDetails}>
              ...
              <li className={styles.disabled}>Create tax-efficient portfolios</li>
            </ul>
            <a href={registerPath} className={cn(styles.pageLink, styles.btn4)}>
              GET COMMUNITY
            </a>
          </div>
          <div className={cn(styles.plan, styles.plan2)}>
            <div className={cn(styles.title, styles.title2)}>
              ...
              <div>
                <span className={styles.price}>
                  <span className={styles.numbers}>$99</span>/year
                </span>
              </div>
              <div>
                <span className={styles.priceSubtext}>$0 for Questrade Clients</span>&#42;
              </div>
            </div>
            <ul className={styles.planDetails}>
              <li>Automated calculations</li>
        ...
        <div className={styles.pricingFooter}>
          <p className={styles.pricingFooterTitle}>
            Money-back <span className={styles.textGreen}>GUARANTEE</span>
          </p>
          <p className={styles.pricingFooterText}>We offer a no-risk, 100% money-back guarantee.</p>
          <p className={styles.pricingFooterText}>If you're not happy, we'll refund you.</p>
        </div>
        <div className={styles.pricingFooter}>
          <p className={styles.pricingSubtext}>
            &#42; Questrade covers the cost of Passiv Elite subscriptions for their customers on an
            annual basis and reserves the right to discontinue at any point.
          </p>
        </div>
      </Container>
    </div>
