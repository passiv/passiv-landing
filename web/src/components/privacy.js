    ...
    <article className={cn(styles.postPage,styles.Privacy)}>
      <Container>
        ...
        <div className={styles.postContent}>
            ...
            <h3>Contact</h3>
            <p>
                Should you require any further information about Passiv’s GDPR statements, please feel free to reach out using Passiv’s <a href="/app/help/">feedback form</a>.
            </p>
        </div>
      </Container>
    </article>
