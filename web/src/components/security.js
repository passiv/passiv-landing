      ...
      <Container>
        ...
        <div className={styles.postContent}>
          ...
          <ul>
            ...
            <li>Should the user wish to revoke Passiv’s access, they can delete the connection within Passiv or do so from the application dashboard within their brokerage account.</li>
          </ul>
          ...
          <p>Your investment account information is not shared with any other party, except when included with communications such as emails or other messaging. Application usage data may be shared with third-party services including Google Analytics, Reddit, and Facebook.</p>

          <h2 id="how-we-secure-your-personal-data">How we secure your personal data</h2>

          <p>Passiv runs its software on servers in a major datacentre. Our servers are hosted in Canada and fall under the jurisdiction of the Canadian legal system. We limit server access to only key employees who need access to production resources. The server is frequently screened for vulnerabilities and patched where appropriate. Standard security practices such as a firewall and SSH keys are used to limit access and reduce attack surface. All networked services running on the server are locally bound and password protected where possible. Database backups are made frequently and strongly encrypted before uploading to a secure remote location. All data is encrypted at rest and in transit using SSL.</p>

          <h2 id="data-subprocessors">Data subprocessors</h2>

          <p>Passiv employs a number of third party services to help us run our business. Only relevant data is shared as needed with subprocessors, and is anonymized where possible.</p>
